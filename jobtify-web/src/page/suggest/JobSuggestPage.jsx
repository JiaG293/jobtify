...
import PaginantionSuggest from "../../components/suggest/PaginationSuggest";
...
const JobSuggestPage = () => {
  const [job, setJob] = useState({

  });
  const { getDataJobSuggest, dataJob } = useJobStore();
  ...
  return (
    <div className="container mx-auto px-6 py-8">
      ...
      <PaginantionSuggest></PaginantionSuggest>
    </div>
  );
};

export default JobSuggestPage;
